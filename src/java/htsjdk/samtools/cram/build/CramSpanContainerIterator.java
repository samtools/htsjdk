...
public class CramSpanContainerIterator implements Iterator<Container> {
    ...
    private CramSpanContainerIterator(final SeekableStream ss, final long[] coordinates) throws IOException {
        this.ss = ss;
        ss.seek(0);
    ...
    public static CramSpanContainerIterator fromFileSpan(final SeekableStream ss, final long[] coordinates) throws IOException {
    ...
    private class Boundary {
        ...
        Container next() throws IOException {
            ...
            final long offset = ss.position();
            final Container c = ContainerIO.readContainer(cramHeader.getVersion(), ss);
            c.offset = offset;
            return c;
        }
    }
