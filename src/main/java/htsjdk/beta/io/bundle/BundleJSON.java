...
public class BundleJSON {
    ...
    private static final Set<String> TOP_LEVEL_PROPERTIES = Set.of(JSON_PROPERTY_SCHEMA, JSON_PROPERTY_PRIMARY);
    ...
    private static <T extends IOPath> IOPathResource toBundleResource(
            final String contentType, final JSONObject jsonObject, final Function<String, T> ioPathConstructor) {
    ...
    private static <T extends IOPath> Collection<BundleResource> toBundleResources(
            final JSONObject jsonResources, final Function<String, T> ioPathConstructor) {
