...
public class ContainerParser {
  ...
  public Map<Integer, AlignmentSpan> getReferences(
  ...
  private static Map<Integer, AlignmentSpan> addAllSpans(
      final Map<Integer, AlignmentSpan> spanMap, final Map<Integer, AlignmentSpan> addition) {
  ...
  Map<Integer, AlignmentSpan> getReferences(
      final Slice slice,
    ...
    switch (slice.sequenceId) {
      ...
      case Slice.MULTI_REFERENCE:
        ...
        final RefSeqIdReader reader =
            new RefSeqIdReader(Slice.MULTI_REFERENCE, slice.alignmentStart, validationStringency);
      ...
      default:
        addSpan(
            slice.sequenceId, slice.alignmentStart, slice.alignmentSpan, slice.nofRecords, spanMap);
        break;
    }
    return spanMap;
  }
  ...
  List<CramCompressionRecord> getRecords(
      final Slice slice,
      final CompressionHeader header,
      final ValidationStringency validationStringency)
      throws IllegalArgumentException, IllegalAccessException {
