 ...
 * block data is *not* populated, including the compression header block and slices.
 *
 * <p>This class is useful when you are not interested in the contents of containers, for example
 * when indexing container start positions.
 */
public class CramContainerHeaderIterator extends CramContainerIterator {
  ...
  protected Container containerFromStream(
      final Version cramVersion, final CountingInputStream countingStream) throws IOException {
