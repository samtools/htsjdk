...
public class CramIO {
     ...
     */
    public static long writeCRAMEOF(final Version version, final OutputStream outputStream) {
        try {
    ...
    /**
     * Read CRAM header, including the SAMFileHeader container from the given {@link InputStream}.
     *
