...
/**
 * An iterator of CRAM containers read from locations in {@link
 * htsjdk.samtools.seekablestream.SeekableStream}. The locations are specified with pairs of
 * coordinates, they are basically file pointers as returned for example by {@link
 * htsjdk.samtools.SamReader.Indexing#getFilePointerSpanningReads()}
 */
public class CramSpanContainerIterator implements Iterator<Container> {
  ...
  public static CramSpanContainerIterator fromFileSpan(
      final SeekableStream seekableStream, final long[] coordinates) throws IOException {
