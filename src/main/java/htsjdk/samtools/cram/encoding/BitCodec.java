...
/**
 * An interface that defines requirements for serializing/deserializing objects into and from a bit
 * stream.
 *
 * @param <T> data series type to be read or written
 * @noinspection UnnecessaryInterfaceModifier, UnnecessaryInterfaceModifier,
 *     UnnecessaryInterfaceModifier, UnnecessaryInterfaceModifier, UnnecessaryInterfaceModifier,
 *     UnnecessaryInterfaceModifier, UnnecessaryInterfaceModifier
 */
public interface BitCodec<T> {
   ...
   *
   * @param bitInputStream the bit input stream to rad from param valueLen the number of elements to
   *     read
   * @return an object from the stream
   * @throws IOException as per java IO contract
   */
  ...
  /**
   * Read a array of specified length from the bit stream into a given byte array. This method is a
   * way to optimize byte array IO operations by bypassing abstraction. Leaky, I know.
   *
   * @param bitInputStream the bit input stream to rad from
