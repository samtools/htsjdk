...
public class ByteArrayLenEncoding implements Encoding<byte[]> {
  ...
  public static EncodingParams toParam(
      final EncodingParams lenParams, final EncodingParams byteParams) {
  ...
  public BitCodec<byte[]> buildCodec(
    ...
    return new ByteArrayLenCodec(
        lenEncoding.buildCodec(inputMap, outputMap), byteEncoding.buildCodec(inputMap, outputMap));
  }
  ...
  private static class ByteArrayLenCodec extends AbstractBitCodec<byte[]> {
    ...
    public ByteArrayLenCodec(final BitCodec<Integer> lenCodec, final BitCodec<byte[]> byteCodec) {
      super();
