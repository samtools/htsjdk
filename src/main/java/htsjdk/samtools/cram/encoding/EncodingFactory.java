...
/**
 * A helper class to instantiate an appropriate {@link htsjdk.samtools.cram.encoding.Encoding} for a
 * given {@link htsjdk.samtools.cram.encoding.DataSeriesType} and {@link
 * htsjdk.samtools.cram.encoding.Encoding}. Also useful to hide encoding implementations.
 */
...
public class EncodingFactory {
   ...
   */
  public <T> Encoding<T> createEncoding(final DataSeriesType valueType, final EncodingID id) {
    switch (valueType) {
      case BYTE:
        switch (id) {
          case EXTERNAL:
