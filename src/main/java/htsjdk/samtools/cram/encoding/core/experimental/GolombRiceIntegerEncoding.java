...
public final class GolombRiceIntegerEncoding extends ExperimentalEncoding<Integer> {
     ...
     * @return GolombRiceIntegerEncoding with parameters populated from serializedParams
     */
    public static GolombRiceIntegerEncoding fromSerializedEncodingParams(final byte[] serializedParams) {
    ...
    public CRAMCodec<Integer> buildCodec(
        ...
        return new GolombRiceIntegerCodec(
