  ...
  static void uncompress(
    ...
    switch (out_sz & 3) {
      ...
      case 1:
        ...
        Decoding.RansDecAdvanceSymbol(rans0, in, syms[0xFF & c], Constants.TF_SHIFT);
        out.put(c);
        break;
      ...
      case 2:
        ...
        Decoding.RansDecAdvanceSymbol(rans1, in, syms[0xFF & c], Constants.TF_SHIFT);
        out.put(c);
        break;
      ...
      case 3:
        ...
        Decoding.RansDecAdvanceSymbol(rans2, in, syms[0xFF & c], Constants.TF_SHIFT);
        out.put(c);
        break;
    }
