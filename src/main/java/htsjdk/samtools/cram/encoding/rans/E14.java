...
class E14 {
  ...
  static int compress(final ByteBuffer in, final RansEncSymbol[][] syms, final ByteBuffer out_buf) {
    ...
    int l0 = 0;
    if (i0 + 1 >= 0) l0 = 0xFF & in.get(i0 + 1);
    int l1 = 0;
    if (i1 + 1 >= 0) l1 = 0xFF & in.get(i1 + 1);
    int l2 = 0;
    if (i2 + 1 >= 0) l2 = 0xFF & in.get(i2 + 1);
    int l3;
