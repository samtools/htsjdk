...
/**
 * A substitution event captured in read coordinates. It is characterized by position in read, read
 * base and reference base. The class is also responsible for converting combinations of read base
 * and reference base into a byte value (code).
 *
 * <p>Both reference and read bases must be ACGTN only.
 */
public class Substitution implements Serializable, ReadFeature {
  ...
  private byte base = -1;
  /**
   * The reference sequence base matching the position of this substitution, allowed values are
   * ACGTN.
   */
