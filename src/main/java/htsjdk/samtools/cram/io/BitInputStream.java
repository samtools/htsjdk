...
/**
 * An interface to describe the requirements for reading bit data as opposed to bytes. Implementors
 * must keep track of the amount of data read similar to {@link InputStream} concept.
 */
