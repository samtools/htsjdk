...
/**
 * An interface to describe the requirements for writing out bits as opposed to bytes. Implementors
 * must keep track of the amount of data written similar to {@link OutputStream} concept and provide
 * flush/close functionality accordingly.
 */
public interface BitOutputStream extends Closeable, Flushable {

  /**
   * Write specified number of bits supplied in the integer value. The method is naturally limited
   * to 32 bits max.
   *
  ...
  /**
   * Write specified number of bits supplied in the long value. The method is naturally limited to
   * 64 bits max.
   *
   * @param bitContainer an integer containing the bits to be written out
  ...
  /**
   * Write specified number of bits supplied in the byte value. The method is naturally limited to 8
   * bits max.
   *
   * @param bitContainer an integer containing the bits to be written out
