...
/**
 * An output stream that calculates CRC32 checksum of all the bytes written through the stream. The
 * java {@link java.util.zip.CRC32} class is used to internally.
 */
