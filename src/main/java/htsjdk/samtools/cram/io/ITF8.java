...
public class ITF8 {
  ...
  /**
   * Reads an unsigned (32 bit) integer from an {@link InputStream}. The sign bit should be
   * interpreted as a value bit.
   *
  ...
  /**
   * Writes an unsigned (32 bit) integer to an {@link OutputStream} encoded as ITF8. The sign bit is
   * interpreted as a value bit.
   *
  ...
  /**
   * Reads an unsigned (32 bit) integer from an array of bytes. The sign bit should be interpreted
   * as a value bit.
   *
  ...
  /**
   * Writes an unsigned (32 bit) integer to a byte new array encoded as ITF8. The sign bit is
   * interpreted as a value bit.
   *
   * @param value the value to be written out
  ...
  /**
   * Reads an unsigned (32 bit) integer from a {@link ByteBuffer}. The sign bit should be
   * interpreted as a value bit.
   *
