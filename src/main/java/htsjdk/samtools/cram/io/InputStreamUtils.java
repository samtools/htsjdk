...
public class InputStreamUtils {
  ...
  /**
   * Read the specified number of bytes from the {@link InputStream} into a new byte array. The
   * length of the array is less or equal to length.
   *
  ...
  /**
   * Read the specified number of bytes from the {@link InputStream} into the byte array starting
   * from the specified position. The length of the array is less or equal to length.
   *
   * @param inputStream the input stream to read from
  ...
  public static void readFully(
      final InputStream inputStream, final byte[] b, final int off, final int length)
      throws IOException {
