...
public class CramCompressionRecord {
  ...
  public boolean equals(final Object obj) {
    ...
    return Arrays.equals(qualityScores, cramRecord.qualityScores)
        && areEqual(flags, cramRecord.flags)
        && areEqual(readName, cramRecord.readName);
  }
  ...
  public String toString() {
    ...
    stringBuilder
        .append("flags=")
        .append(flags)
        .append("; alignmentOffset=")
        .append(alignmentDelta)
        .append("; mateOffset=")
        .append(recordsToNextFragment)
        .append("; mappingQuality=")
        .append(mappingQuality);
    ...
    if (readBases != null)
      stringBuilder.append("; ").append("bases: ").append(new String(readBases));
    if (qualityScores != null)
      stringBuilder.append("; ").append("scores: ").append(new String(qualityScores));
  ...
  public void setSecondaryAlignment(final boolean secondaryAlignment) {
    flags =
        secondaryAlignment ? flags | SECONDARY_ALIGNMENT_FLAG : flags & ~SECONDARY_ALIGNMENT_FLAG;
  }
  ...
  public void setMateNegativeStrand(final boolean mateNegativeStrand) {
    mateFlags =
        mateNegativeStrand ? mateFlags | MATE_NEG_STRAND_FLAG : mateFlags & ~MATE_NEG_STRAND_FLAG;
  }
  ...
  public void setHasMateDownStream(final boolean hasMateDownStream) {
    compressionFlags =
        hasMateDownStream
            ? compressionFlags | HAS_MATE_DOWNSTREAM_FLAG
            : compressionFlags & ~HAS_MATE_DOWNSTREAM_FLAG;
  }
  ...
  public void setDetached(final boolean detached) {
    compressionFlags =
        detached ? compressionFlags | DETACHED_FLAG : compressionFlags & ~DETACHED_FLAG;
  }
  ...
  public void setForcePreserveQualityScores(final boolean forcePreserveQualityScores) {
    compressionFlags =
        forcePreserveQualityScores
            ? compressionFlags | FORCE_PRESERVE_QS_FLAG
            : compressionFlags & ~FORCE_PRESERVE_QS_FLAG;
  }
  ...
  public void setUnknownBases(final boolean unknownBases) {
    compressionFlags =
        unknownBases ? compressionFlags | UNKNOWN_BASES : compressionFlags & ~UNKNOWN_BASES;
  }
