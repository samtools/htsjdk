        ...
        for (final SubstitutionBase r : SubstitutionBase.values()) {
            for (final SubstitutionBase b : SubstitutionBase.values()) {
                if (r != b) {
                    ...
                    // propagate the same code for lower case bases in order to handle substitutions of
                    // lower case reference bases that might have been generated by other CRAM writers
