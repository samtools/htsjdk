...
/**
 * That is a thread-safe wrapper for a list of cache Reference objects. Those objects can be used
 * from different threads without issues, however to load and save a Reference object, we need to
 * acquire a lock.
 *
...
public class ReferenceCache {
  ...
  /**
   * This method returns Reference objects by reference indexes in SAM header Those objects do not
