...
/**
 * Iterator for unaligned reads. Is used from SRAIterator.
 *
 * <p>Created by andrii.nikitiuk on 9/3/15.
 */
public class SRAUnalignmentIterator implements Iterator<SAMRecord> {
  ...
  public SRAUnalignmentIterator(
    ...
    try {
      unalignedIterator =
          run.getReadRange(
              readStart + 1, readEnd - readStart, Read.partiallyAligned | Read.unaligned);
