...
/**
 * Abstract implementation of a Little progress logging class to facilitate consistent output of
 * useful information when progressing through a stream of SAM records.
 *
 * <p>Concrete subclasses must provide the logger
 */
public abstract class AbstractProgressLogger implements ProgressLoggerInterface {
   ...
   *
   * <p>This must be called by any subclasses
   *
   ...
   *
   * @param message a message to be logged by the logger (recommended output level is INFO or the
   *     equivalent)
   */
