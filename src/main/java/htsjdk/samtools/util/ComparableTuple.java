...
/**
 * A simple extension of the Tuple class that, for comparable Types, allows comparing Tuples of
 * non-null elements.
 *
 * <p>The comparison will compare the first arguments and if equal (compareTo returns 0) compare the
 * second arguments.
 *
 * @author farjoun
 */
  ...
  public ComparableTuple(final A a, final B b) {
    ...
    if (a == null || b == null) {
      throw new IllegalArgumentException(
          "ComparableTuple's behavior is undefined when containing a null.");
    }
  }
