...
/**
 * Provides an implementation of the Murmur3_32 hash algorithm that has desirable properties in
 * terms of randomness and uniformity of the distribution of output values that make it a useful
 * hashing algorithm for downsampling.
 */
