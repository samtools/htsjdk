...
public class FTPClient {
  ...
  /**
   * Stream to write commands. NOTE -- a PrintStream is used no purpose (as opposed to PrintWriter).
   * PrintWriter will not work!
   */
  ...
  /**
   * Executes the given FTP command on our current connection, returning the three digit response
   * code from the server. This method only works for commands that do not require an additional
   * data port.
   */
