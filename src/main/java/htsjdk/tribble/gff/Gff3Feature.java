 ...
 * 
 * This interface is also used for GTF
 */
public interface Gff3Feature extends Feature {
    /**
     * Get the set of top level features from which this feature is descended. Top level features
     * are features with no linked parents
     * 
    ...
    /**
     * Get set of all features this feature descends from, through chains of Parent attributes. If
     * Derives_From exists for this feature, then only features along the inheritance path specified
     * by the Derives_From attribute should be included as ancestors of this feature
     * 
    ...
    /**
     * Get set of all features descended from this features, through chains of Parent attributes. If
     * Derives_From attribute exists for a feature, it should only be included as a descendent of
     * this feature if the inheritance path specified by its Derives_From attribute includes this
     * feature
     * 
    ...
    /***
     * Flatten this feature and all descendents into a set of features. The Derives_From attribute
     * is respected if it exists for this feature
     * 
