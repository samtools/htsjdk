...
/**
 * An AsciiLineReader implementation that wraps a BlockCompressedInputStream and provides no
 * additional buffering. Useful for cases where we need to preserve virtual file pointers in the
 * underlying stream, such as during indexing.
 */
class BlockCompressedAsciiLineReader extends AsciiLineReader {

  private final BlockCompressedInputStream bcs;

  public BlockCompressedAsciiLineReader(
      final BlockCompressedInputStream inputBlockCompressedStream) {
