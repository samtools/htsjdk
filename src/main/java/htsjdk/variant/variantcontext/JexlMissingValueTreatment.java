...
/**
 * How to treat values that appear in a jexl expression but are missing in the context it's applied
 * to
 */
public enum JexlMissingValueTreatment {
  ...
  /**
   * Treat expressions with a missing value as an error and throw an {@link
   * IllegalArgumentException}
   */
  THROW(
      () -> {
        throw new IllegalArgumentException(
            "Jexl Expression couldn't be evaluated because there was a missing value.");
      });
