...
public class BAMQueryMultipleIntervalsIteratorFilterTest extends HtsjdkTest {
  ...
  public void testCompareIntervalToRecord(
    ...
    Assert.assertEquals(
        BAMQueryMultipleIntervalsIteratorFilter.compareIntervalToRecord(query, samRec),
        expectedState);
  }
  ...
  public void testCompareToFilter(
    ...
    SAMRecord samRec = getSAMRecord(refIndex, start, length);
    BAMQueryMultipleIntervalsIteratorFilter it =
        new BAMQueryMultipleIntervalsIteratorFilter(query, contained);
