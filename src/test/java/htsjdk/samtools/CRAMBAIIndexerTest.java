...
//        final Container container1 = FACTORY.buildContainer(
//                CRAMStructureTestUtil.getSingleRefRecords(RECORDS_PER_SLICE, refId1), dummyByteOffset);
//        final Container container2 = FACTORY.buildContainer(
//                CRAMStructureTestUtil.getSingleRefRecords(RECORDS_PER_SLICE, refId2), dummyByteOffset);
        ...
        //TODO: CRAMStructureTestUtil.getSingleRefRecords returns some unmapped/placed
        final Container container1 = CRAMStructureTestHelper.getSingleContainerFromRecords(
                containerFactory,
                CRAMStructureTestHelper.createMappedSAMRecords(RECORDS_PER_SLICE, refId1),
                dummyByteOffset);
        final Container container2 = CRAMStructureTestHelper.getSingleContainerFromRecords(
                containerFactory,
...
//        assertIndexMetadata(index, refId2, expectedMapped, expectedUnmappedPlaced);
        //TODO: CRAMStructureTestUtil.getSingleRefRecords returns some unmapped/placed
        assertIndexMetadata(index, refId1, 3, 0);
        assertIndexMetadata(index, refId2, 3, 0);
    }
