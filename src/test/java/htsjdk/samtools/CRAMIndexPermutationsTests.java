...
public class CRAMIndexPermutationsTests extends HtsjdkTest {
    ...
    private static final ReferenceSource fakeReferenceSource =
            new ReferenceSource(new FakeReferenceSequenceFile(SamReaderFactory.makeDefault()
                    .getFileHeader(truthBAM)
        ...
        return baiCramCache.computeIfAbsent(strategy.toString(), k -> {
            try {
                return CRAMIndexTestHelper.createCRAMWithBAIForEncodingStrategy(
                        truthBAM, fakeReferenceSource, strategy);
    ...
    final CRAMEncodingStrategy strategy1000x1 =
            new CRAMEncodingStrategy().setMinimumSingleReferenceSliceSize(100).setReadsPerSlice(1000);
    final CRAMEncodingStrategy strategy500x1 =
            new CRAMEncodingStrategy().setMinimumSingleReferenceSliceSize(100).setReadsPerSlice(500);
    final CRAMEncodingStrategy strategy200x1 =
            new CRAMEncodingStrategy().setMinimumSingleReferenceSliceSize(100).setReadsPerSlice(200);
    final CRAMEncodingStrategy strategy100x1 =
    ...
    final CRAMEncodingStrategy strategy5000x2 = new CRAMEncodingStrategy()
            .setMinimumSingleReferenceSliceSize(100)
            .setReadsPerSlice(5000)
            .setSlicesPerContainer(2);
    final CRAMEncodingStrategy strategy1000x2 = new CRAMEncodingStrategy()
            .setMinimumSingleReferenceSliceSize(100)
            .setReadsPerSlice(1000)
            .setSlicesPerContainer(2);
    final CRAMEncodingStrategy strategy500x2 = new CRAMEncodingStrategy()
            .setMinimumSingleReferenceSliceSize(100)
            .setReadsPerSlice(500)
            .setSlicesPerContainer(2);
    final CRAMEncodingStrategy strategy200x2 = new CRAMEncodingStrategy()
            .setMinimumSingleReferenceSliceSize(100)
            .setReadsPerSlice(200)
            .setSlicesPerContainer(2);
    final CRAMEncodingStrategy strategy100x2 = new CRAMEncodingStrategy()
            .setMinimumSingleReferenceSliceSize(100)
            .setReadsPerSlice(100)
            .setSlicesPerContainer(2);
    ...
    public void testQueryUnmappedOnUnmappedOnlyInput(final CRAMEncodingStrategy cramEncodingStrategy)
            throws IOException {
