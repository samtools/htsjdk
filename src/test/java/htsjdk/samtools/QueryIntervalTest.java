...
public class QueryIntervalTest extends HtsjdkTest {
  ...
  public void testOptimizeIntervals() throws Exception {
    ...
    final QueryInterval[] optimizedOverlapping =
        QueryInterval.optimizeIntervals(overlappingIntervals);
    ...
    final QueryInterval[] optimizedSeparated =
        QueryInterval.optimizeIntervals(nonOptimizableSeparatedIntervals);
