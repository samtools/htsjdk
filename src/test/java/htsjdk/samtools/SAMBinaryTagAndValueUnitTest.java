...
public class SAMBinaryTagAndValueUnitTest extends HtsjdkTest {
  ...
  public void test_isAllowedConstructor(final Object value) {
    Assert.assertNotNull(
        new SAMBinaryTagAndValue(SAMTagUtil.getSingleton().makeBinaryTag("UI"), value));
  }
  ...
  @Test(
      dataProvider = "notAllowedAttributeTypes",
  ...
  @Test(
      dataProvider = "notAllowedUnsignedArrayTypes",
      expectedExceptions = IllegalArgumentException.class)
  ...
  public Object[][] hashCopyEquals() {
    ...
    return new Object[][] {
      ...
      {
        new SAMBinaryTagAndValue(tag, new Byte((byte) 0)),
        new SAMBinaryTagAndValue(tag, new Byte((byte) 0)),
        true,
        true
      },
      {
        new SAMBinaryTagAndValue(tag, new Byte((byte) 0)),
        new SAMBinaryTagAndValue(tag, new Byte((byte) 1)),
        false,
        false
      },
      {
        new SAMBinaryTagAndValue(tag, new Short((short) 0)),
        new SAMBinaryTagAndValue(tag, new Short((short) 0)),
        true,
        true
      },
      {
        new SAMBinaryTagAndValue(tag, new Short((short) 0)),
        new SAMBinaryTagAndValue(tag, new Short((short) 1)),
        false,
        false
      },
      {
        new SAMBinaryTagAndValue(tag, new Integer(0)),
        new SAMBinaryTagAndValue(tag, new Integer(0)),
        true,
        true
      },
      ...
      {
        new SAMBinaryTagAndValue(tag, new Character('C')),
        new SAMBinaryTagAndValue(tag, new Character('C')),
        true,
        true
      },
      {
        new SAMBinaryTagAndValue(tag, new Character('C')),
        new SAMBinaryTagAndValue(tag, new Character('D')),
        false,
        false
      },
      {
        new SAMBinaryTagAndValue(tag, new Float(0.1F)),
        new SAMBinaryTagAndValue(tag, new Float(0.1F)),
        true,
        true
      },
      {
        new SAMBinaryTagAndValue(tag, new Float(0.1F)),
        new SAMBinaryTagAndValue(tag, new Float(0.2F)),
        false,
        false
      },
      {
        new SAMBinaryTagAndValue(tag, new Long(37L)),
        new SAMBinaryTagAndValue(tag, new Long(37L)),
        true,
        true
      },
      {
        new SAMBinaryTagAndValue(tag, new Long(37L)),
        new SAMBinaryTagAndValue(tag, new Long(38L)),
        false,
        false
      },
      {
        new SAMBinaryTagAndValue(tag, new Long(BinaryCodec.MAX_UINT)),
        new SAMBinaryTagAndValue(tag, new Long(BinaryCodec.MAX_UINT)),
        true,
        true
      },
      {
        new SAMBinaryTagAndValue(tag, new Long(BinaryCodec.MAX_UINT)),
        new SAMBinaryTagAndValue(tag, new Long(BinaryCodec.MAX_UINT - 1)),
        false,
        false
      },
      ...
      {
        new SAMBinaryTagAndUnsignedArrayValue(tag, new byte[] {0, 1, 2}),
        new SAMBinaryTagAndUnsignedArrayValue(tag, new byte[] {0, 1, 2}),
        true,
        true
      },
      {
        new SAMBinaryTagAndUnsignedArrayValue(tag, new byte[] {0, 1, 2}),
        new SAMBinaryTagAndUnsignedArrayValue(tag, new byte[] {3, 4, 5}),
        false,
        false
      },
      {
        new SAMBinaryTagAndUnsignedArrayValue(tag, new short[] {0, 1, 2}),
        new SAMBinaryTagAndUnsignedArrayValue(tag, new short[] {0, 1, 2}),
        true,
        true
      },
      {
        new SAMBinaryTagAndUnsignedArrayValue(tag, new short[] {0, 1, 2}),
        new SAMBinaryTagAndUnsignedArrayValue(tag, new short[] {3, 4, 5}),
        false,
        false
      },
      {
        new SAMBinaryTagAndUnsignedArrayValue(tag, new int[] {0, 1, 2}),
        new SAMBinaryTagAndUnsignedArrayValue(tag, new int[] {0, 1, 2}),
        true,
        true
      },
      {
        new SAMBinaryTagAndUnsignedArrayValue(tag, new int[] {0, 1, 2}),
        new SAMBinaryTagAndUnsignedArrayValue(tag, new int[] {3, 4, 5}),
        false,
        false
      },
      ...
      {
        new SAMBinaryTagAndValue(tag, new short[] {0, 1, 2}),
        new SAMBinaryTagAndUnsignedArrayValue(tag, new short[] {0, 1, 2}),
        true,
        false
      },
      ...
      {
        new SAMBinaryTagAndValue(tag, new short[] {0, 1, 2}),
        new SAMBinaryTagAndUnsignedArrayValue(tag, new short[] {1, 1, 3}),
        false,
        false
      },
    };
