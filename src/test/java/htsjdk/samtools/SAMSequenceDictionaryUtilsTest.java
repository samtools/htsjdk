...
public final class SequenceDictionaryUtilsUnitTest extends GATKBaseTest {
    ...
    public void testSequenceRecordsAreEquivalent(final SAMSequenceRecord one, final SAMSequenceRecord two, final boolean expected){
        final boolean actual = org.broadinstitute.hellbender.utils.SequenceDictionaryUtils.sequenceRecordsAreEquivalent(one, two);
    ...
    public void testSequenceDictionaryValidation(final List<SAMSequenceRecord> firstDictionaryContigs,
                                                 ...
                                                 final org.broadinstitute.hellbender.utils.SequenceDictionaryUtils.SequenceDictionaryCompatibility dictionaryCompatibility, //not needed by this test
        ...
        final String testDescription = String.format("First dictionary: %s  Second dictionary: %s",
                org.broadinstitute.hellbender.utils.SequenceDictionaryUtils.getDictionaryAsString(firstDictionary),
                org.broadinstitute.hellbender.utils.SequenceDictionaryUtils.getDictionaryAsString(secondDictionary));
        Exception exceptionThrown = null;
        try {
            org.broadinstitute.hellbender.utils.SequenceDictionaryUtils.validateDictionaries(
                    "firstDictionary",
                    firstDictionary,
                    "secondDictionary",
                    secondDictionary,
    ...
    public void testSequenceDictionaryComparison( final List<SAMSequenceRecord> firstDictionaryContigs,
                                                  final List<SAMSequenceRecord> secondDictionaryContigs,
                                                  final org.broadinstitute.hellbender.utils.SequenceDictionaryUtils.SequenceDictionaryCompatibility dictionaryCompatibility,
                                                  final Class<? extends UserException> expectedExceptionUponValidation,
                                                  final boolean requireSuperset,
                                                  final boolean checkContigOrdering) {
        ...
        final org.broadinstitute.hellbender.utils.SequenceDictionaryUtils.SequenceDictionaryCompatibility reportedCompatibility =
                org.broadinstitute.hellbender.utils.SequenceDictionaryUtils.compareDictionaries(firstDictionary, secondDictionary, checkContigOrdering);
    ...
    public void testStandardValidationIgnoresContigOrder( final List<SAMSequenceRecord> firstDictionaryContigs, final List<SAMSequenceRecord> secondDictionaryContigs ) {
        ...
        org.broadinstitute.hellbender.utils.SequenceDictionaryUtils.validateDictionaries("first", firstDictionary, "second", secondDictionary);
    }
    ...
    public void testCRAMValidationDoesRequireSuperset( final List<SAMSequenceRecord> refDictionaryContigs, final List<SAMSequenceRecord> cramDictionaryContigs ) {
        ...
        org.broadinstitute.hellbender.utils.SequenceDictionaryUtils.validateCRAMDictionaryAgainstReference(refDictionary, cramDictionary);
    }
