    ...
    public static void doCRAMCompare(
        ...
        try (final SamReader reader1 = SamReaderFactory.makeDefault()
            ...
            for (final SAMRecord rec1 : reader1) {
                ...
                count++;
                if (!rec1.equals(rec2)) {
                    System.out.println(String.format("%s%s", rec1.getReadUnmappedFlag() == true ? "unmapped: " : "", rec1.getSAMString()));
                    System.out.println(String.format("%s%s", rec2.getReadUnmappedFlag() == true ? "unmapped: " : "", rec2.getSAMString()));
                    diffCount++;
                }
                if (count % 10000000 == 0) {
