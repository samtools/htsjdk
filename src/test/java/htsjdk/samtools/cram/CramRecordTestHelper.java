...
public abstract class CramRecordTestHelper extends HtsjdkTest {
    ...
    public List<CramCompressionRecord> createRecords() {
        ...
        record1.mateReferenceContext = new ReferenceContext(5);
        record1.mateAlignmentStart = 30;
        record1.mappingQuality = 30;
        record1.sequenceName = "SEQNAME";
        record1.referenceContext = new ReferenceContext(3);
        ...
        record2.mateReferenceContext = new ReferenceContext(33);
        record2.mateAlignmentStart = 3;
        record2.mappingQuality = 15;
        record2.sequenceName = "SEQNAME2";
        record2.referenceContext = new ReferenceContext(1);
        ...
        record3.mateReferenceContext = new ReferenceContext(1);
        record3.mateAlignmentStart = 20;
        record3.mappingQuality = 20;
        record3.sequenceName = "SEQNAME3";
        record3.referenceContext = new ReferenceContext(10);
        ...
        record4.mateReferenceContext = new ReferenceContext(0);
        record4.mateAlignmentStart = 11;
        record4.mappingQuality = 50;
        record4.sequenceName = "SEQNAME4";
        record4.referenceContext = new ReferenceContext(0);
