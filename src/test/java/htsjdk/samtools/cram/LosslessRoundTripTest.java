...
public class LosslessRoundTripTest extends HtsjdkTest {
  ...
  public void test_MD_NM() throws IOException {
    ...
    // setting some bizzar values to provoke test failure if the values are auto-restored while
    // reading CRAM:
    ...
    CRAMFileReader reader =
        new CRAMFileReader(cramInputStream, (File) null, source, ValidationStringency.STRICT);
