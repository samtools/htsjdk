...
public class ContainerParserTest extends HtsjdkTest {
  ...
  public void testEOF() throws IOException, IllegalAccessException {
    ...
    Container container =
        ContainerIO.readContainer(version, new ByteArrayInputStream(v2_baos.toByteArray()));
  ...
  public void testSingleRefContainer() throws IOException, IllegalAccessException {
    ...
    final Map<Integer, AlignmentSpan> referenceSet =
        parser.getReferences(container, ValidationStringency.STRICT);
