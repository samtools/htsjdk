...
public class HuffmanTest extends HtsjdkTest {
    ...
    public void testSingleSymbolAlphabetCodeWordLengthIsZero(final Integer testSymbol, final int nWriteReads) throws IOException {
        ...
        final HuffmanCodecHelper<Integer> helper = new HuffmanCodecHelper(huffmanParams);
    ...
    public void testVerySmallAlphabet(
        ...
        final HuffmanCodecHelper<Byte> huffmanHelper = doHuffmanTest(symbolFrequencies);
    ...
    private static <T> HuffmanCodecHelper<T> doHuffmanTest(final Map<T, Integer> symbolFrequencies) throws IOException {
        ...
        final HuffmanCodecHelper<T> helper = new HuffmanCodecHelper(huffmanParams);
