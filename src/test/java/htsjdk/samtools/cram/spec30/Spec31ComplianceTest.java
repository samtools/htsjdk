...
public class Spec31ComplianceTest extends HtsSpecsComplianceTestBase {
    ...
    public void testLevel1() throws IOException {
        final List<SAMRecord> records = decodeCramFile(SPEC_31_DIR.resolve("level-1.cram").toFile());
        Assert.assertFalse(records.isEmpty(), "3.1 level-1 should have records");
    }

    @Test
    public void testLevel2() throws IOException {
        final List<SAMRecord> records = decodeCramFile(SPEC_31_DIR.resolve("level-2.cram").toFile());
        Assert.assertFalse(records.isEmpty(), "3.1 level-2 should have records");
    }

    @Test
    public void testLevel3() throws IOException {
        final List<SAMRecord> records = decodeCramFile(SPEC_31_DIR.resolve("level-3.cram").toFile());
        Assert.assertFalse(records.isEmpty(), "3.1 level-3 should have records");
    }

    @Test
    public void testLevel4() throws IOException {
        final List<SAMRecord> records = decodeCramFile(SPEC_31_DIR.resolve("level-4.cram").toFile());
    ...
    public void testAll31LevelsProduceSameOutput() throws IOException {
        final List<SAMRecord> level1 = decodeCramFile(SPEC_31_DIR.resolve("level-1.cram").toFile());
        final List<SAMRecord> level2 = decodeCramFile(SPEC_31_DIR.resolve("level-2.cram").toFile());
        final List<SAMRecord> level3 = decodeCramFile(SPEC_31_DIR.resolve("level-3.cram").toFile());
        final List<SAMRecord> level4 = decodeCramFile(SPEC_31_DIR.resolve("level-4.cram").toFile());
    ...
    public void test31MatchesSame30Content() throws IOException {
        ...
        final List<SAMRecord> v31 = decodeCramFile(SPEC_31_DIR.resolve("level-1.cram").toFile());
