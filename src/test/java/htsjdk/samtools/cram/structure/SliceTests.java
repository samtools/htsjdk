...
public class SliceTests extends HtsjdkTest {
    ...
    public void testSpansCoordinateSorted() {
        ...
        final CompressionHeader header = new CompressionHeaderFactory(new CRAMEncodingStrategy()).createCompressionHeader(cramRecords, true);
    ...
    public void testRejectNonCoordinateSortedForSpans() {
        ...
        final CompressionHeader header = new CompressionHeaderFactory(new CRAMEncodingStrategy()).createCompressionHeader(cramRecords, false);
        final Slice slice = new Slice(cramRecords, header, 0L, 0L);
