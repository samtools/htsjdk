...
public class IntervalFilterTest extends HtsjdkTest {
  ...
  public Iterator<Object[]> testReadsData() {
    ...
    tests.add(
        new Object[] {
          list, fileHeader, CollectionUtil.makeCollection(builder.iterator()), expected, total
        });
    ...
    builder.addFrag(
        "intersecting_with_empty" + total, 1, 295, false); // intersects an empty interval
    total += 1;
    expected++;
    tests.add(
        new Object[] {
  ...
  public void testReads(
      final IntervalList list,
      final SAMFileHeader fileHeader,
      final Collection<SAMRecord> recordCollection,
      final int expectedPassing,
    ...
    FilteringSamIterator filteringSamIterator =
        new FilteringSamIterator(recordCollection.iterator(), intervalFilter);
