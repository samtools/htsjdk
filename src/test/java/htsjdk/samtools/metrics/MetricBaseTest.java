...
public class MetricBaseTest extends HtsjdkTest {
  ...
  public Object[][] equalityTestProvider() {
    return new Object[][] {
      ...
      {
        "1", 1.0000000000000000001d, true
      }, /* Object fields are saved using instance of which performs rounding, but loaded as a string*/
      {
        1.00000000000000001d, 1.0000000002918d, true
      }, /* precision limit is set by {@link FormatUtil#DECIMAL_DIGITS_TO_PRINT}, if that changes this test may fail */
      {1.0000, 1.0001, false},
      {1.0, 1.0, true},
      {1, 2, false}
    };
