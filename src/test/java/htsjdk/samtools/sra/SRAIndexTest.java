...
public class SRAIndexTest extends AbstractSRATest {
    ...
    private Object[][] createDataForSpanOverlappings() {
        return new Object[][] {
            ...
            },
            {
                ...
                new long[] {0, SRAIndex.SRA_CHUNK_SIZE, SRAIndex.SRA_CHUNK_SIZE, SRAIndex.SRA_CHUNK_SIZE * 2}
            },
        };
    }
    ...
    public void testSpanOverlappings(
        ...
        Assert.assertTrue(
                ...
                "Coordinates mismatch. Expected: " + Arrays.toString(spanCoordinates) + " but was : "
