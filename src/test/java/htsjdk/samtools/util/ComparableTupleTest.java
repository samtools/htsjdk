...
public class ComparableTupleTest extends HtsjdkTest {
  ...
  public Object[][] testComparableTupleData() {
    return new Object[][] {
      ...
      new Object[] {
        new ComparableTuple<>(1, "hi"), new ComparableTuple<>(1, "bye"), "hi".compareTo("bye")
      },
      ...
      new Object[] {
        new ComparableTuple<>(A, Tenum.Hi),
        new ComparableTuple<>(Aref, Tenum.Bye),
        A.compareTo(Aref)
      },
      new Object[] {
        new ComparableTuple<>(Aref, Tenum.Hi),
        new ComparableTuple<>(Aref, Tenum.Bye),
        Tenum.Hi.compareTo(Tenum.Bye)
      },
      new Object[] {
        new ComparableTuple<>(Aref, Tenum.Hi), new ComparableTuple<>(Aref, Tenum.Hi), 0
      },
      new Object[] {
        new ComparableTuple<>(Aref, Tenum.Hi),
        new ComparableTuple<>(G, Tenum.Ciao),
        Aref.compareTo(G)
      },
      new Object[] {
        new ComparableTuple<>(A, Tenum.Ciao), new ComparableTuple<>(G, Tenum.Hi), A.compareTo(G)
      }
    };
  }

  @Test(dataProvider = "testComparableTupleData")
  public <T extends Comparable<T>, R extends Comparable<R>> void testComparableTuple(
      final ComparableTuple<T, R> lhs, final ComparableTuple<T, R> rhs, final int result) {
  ...
  @Test(
      dataProvider = "testComparableTupleNullData",
