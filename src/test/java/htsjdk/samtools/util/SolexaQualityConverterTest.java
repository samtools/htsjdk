...
public class SolexaQualityConverterTest extends HtsjdkTest {
  ...
  public static Object[][] SOLEXA_QUALS_TO_PHRED_SCORE =
      new Object[][] {
  ...
  public static Object[][] SOLEXA_QUALS_TO_PHRED_SCORE_1_3 =
      new Object[][] {
        new Object[] {new byte[] {}, new byte[] {}},
        new Object[] {iToB(new int[] {120}), iToB(new int[] {56})},
        new Object[] {
          iToB(new int[] {64, 65, 120, 121, 156, 157}), iToB(new int[] {0, 1, 56, 57, 92, 93})
        },
        new Object[] {iToB(new int[] {0, 1, 63}), iToB(new int[] {-64, -63, -1})}
      };

  public static Object[][] INVALID_SOLEXA_QUALS =
      new Object[][] {
  ...
  public Object[][] solexaQualsToPhredScore() {
    return SOLEXA_QUALS_TO_PHRED_SCORE;
  }

  @DataProvider(name = "solexaQualsToPhredScore_1_3")
  public Object[][] solexaQualsToPhredScore_1_3() {
    return SOLEXA_QUALS_TO_PHRED_SCORE_1_3;
  }

  @DataProvider(name = "invalidSolexaQuals")
  public Object[][] invalidSolexaQuals() {
    return INVALID_SOLEXA_QUALS;
  }
