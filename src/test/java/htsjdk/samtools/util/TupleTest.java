...
public class TupleTest extends HtsjdkTest {
  ...
  public void testEquals() throws Exception {
    ...
    Assert.assertNotSame(
        new Tuple<Integer, String>(null, "hi"), new Tuple<String, String>(null, "hi"));
    Assert.assertNotSame(
        new Tuple<Integer, Integer>(null, null), new Tuple<Integer, String>(null, null));
  ...
  public void testHashCode() throws Exception {
    ...
    // even though these are of different types, the value is null and so I have to make these
    // equal...
    Assert.assertEquals(
        new Tuple<Integer, Integer>(1, null).hashCode(),
        new Tuple<Integer, String>(1, null).hashCode());
    Assert.assertEquals(
        new Tuple<Integer, String>(null, "hi").hashCode(),
        new Tuple<String, String>(null, "hi").hashCode());
    Assert.assertEquals(
        new Tuple<Integer, Integer>(null, null).hashCode(),
        new Tuple<Integer, String>(null, null).hashCode());
