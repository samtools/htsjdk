...
public class Gff3CodecTest extends HtsjdkTest {
    ...
    static final String DATA_DIR = TestUtils.DATA_DIR + "/gff/";
    ...
    private final Path feature_extends_past_circular_region =
            Paths.get(DATA_DIR + "feature_extends_past_circular_region.gff3");
    ...
    private final Path ensembl_human_small_gzipped =
            Paths.get(DATA_DIR + "Homo_sapiens.GRCh38.97.chromosome.1.small.gff3.gz");
    ...
    public void basicDecodeTest(final Path inputGff3, final int expectedTotalFeatures) throws IOException {
        ...
        final AbstractFeatureReader<Gff3Feature, LineIterator> reader = AbstractFeatureReader.getFeatureReader(
                inputGff3.toAbsolutePath().toString(), null, new Gff3Codec(), false);
    ...
    public void codecFilterOutFieldsTest(final Path inputGff3, final int expectedTotalFeatures) throws IOException {
        final Set<String> skip_attributes = new HashSet<>(Arrays.asList(
                "version", "rank", "biotype", "transcript_support_level", "mgi_id", "havana_gene", "tag"));
        ...
        final AbstractFeatureReader<Gff3Feature, LineIterator> reader = AbstractFeatureReader.getFeatureReader(
                inputGff3.toAbsolutePath().toString(), null, codec, false);
        int countTotalFeatures = 0;
        for (final Gff3Feature feature : reader.iterator()) {
    ...
    public void basicShallowDecodeTest(final Path inputGff3, final int expectedTotalFeatures) throws IOException {
        Assert.assertTrue((new Gff3Codec(Gff3Codec.DecodeDepth.SHALLOW))
                .canDecode(inputGff3.toAbsolutePath().toString()));
        final AbstractFeatureReader<Gff3Feature, LineIterator> reader = AbstractFeatureReader.getFeatureReader(
                inputGff3.toAbsolutePath().toString(), null, new Gff3Codec(Gff3Codec.DecodeDepth.SHALLOW), false);
        int countTotalFeatures = 0;
        for (final Gff3Feature feature : reader.iterator()) {
            countTotalFeatures++;
    ...
    public void testGZipped(final Path inputGff3, final Path inputGff3GZipped) throws IOException {
        Assert.assertTrue((new Gff3Codec()).canDecode(inputGff3.toAbsolutePath().toString()));
        Assert.assertTrue(
                (new Gff3Codec()).canDecode(inputGff3GZipped.toAbsolutePath().toString()));

        final AbstractFeatureReader<Gff3Feature, LineIterator> reader = AbstractFeatureReader.getFeatureReader(
                inputGff3.toAbsolutePath().toString(), null, new Gff3Codec(), false);
        final AbstractFeatureReader<Gff3Feature, LineIterator> readerGZipped = AbstractFeatureReader.getFeatureReader(
                inputGff3GZipped.toAbsolutePath().toString(), null, new Gff3Codec(), false);
    ...
    public void testGZippedShallow(final Path inputGff3, final Path inputGff3GZipped) throws IOException {
        ...
        final AbstractFeatureReader<Gff3Feature, LineIterator> reader = AbstractFeatureReader.getFeatureReader(
                inputGff3.toAbsolutePath().toString(), null, new Gff3Codec(Gff3Codec.DecodeDepth.SHALLOW), false);
        final AbstractFeatureReader<Gff3Feature, LineIterator> readerGZipped = AbstractFeatureReader.getFeatureReader(
                inputGff3GZipped.toAbsolutePath().toString(),
                null,
                new Gff3Codec(Gff3Codec.DecodeDepth.SHALLOW),
                false);
    ...
    public void urlDecodingTest() throws IOException {
        final AbstractFeatureReader<Gff3Feature, LineIterator> reader =
                AbstractFeatureReader.getFeatureReader(DATA_DIR + "url_encoding.gff3", null, new Gff3Codec(), false);
        ...
        Assert.assertTrue(
                feature.getUniqueAttribute(Gff3Constants.ID_ATTRIBUTE_KEY).isPresent());
    ...
    public Object[][] examplesDataProvider() {
        ...
        // canonical gene
        final ArrayList<Object> canonicalGeneExample =
                new ArrayList<>(Collections.singletonList(DATA_DIR + "canonical_gene.gff3"));

        final Set<Gff3Feature> canonicalGeneFeatures = new HashSet<>();

        final Gff3FeatureImpl canonicalGene_gene00001 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "gene",
                1000,
                ...
                -1,
                ImmutableMap.of(
                        "ID", Collections.singletonList("gene00001"), "Name", Collections.singletonList("EDEN")));
        canonicalGeneFeatures.add(canonicalGene_gene00001);

        final Gff3FeatureImpl canonicalGene_tfbs00001 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "TF_binding_site",
                1000,
                ...
                ImmutableMap.of(
                        "ID",
                        Collections.singletonList("tfbs00001"),
                        "Parent",
                        Collections.singletonList("gene00001")));
        canonicalGene_tfbs00001.addParent(canonicalGene_gene00001);
        canonicalGeneFeatures.add(canonicalGene_tfbs00001);

        final Gff3FeatureImpl canonicalGene_mRNA00001 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "mRNA",
                1050,
                ...
                ImmutableMap.of(
                        "ID",
                        Collections.singletonList("mRNA00001"),
                        "Name",
                        Collections.singletonList("EDEN.1"),
                        "Parent",
                        Collections.singletonList("gene00001")));
        canonicalGene_mRNA00001.addParent(canonicalGene_gene00001);
        canonicalGeneFeatures.add(canonicalGene_mRNA00001);

        final Gff3FeatureImpl canonicalGene_mRNA00002 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "mRNA",
                1050,
                ...
                ImmutableMap.of(
                        "ID",
                        Collections.singletonList("mRNA00002"),
                        "Name",
                        Collections.singletonList("EDEN.2"),
                        "Parent",
                        Collections.singletonList("gene00001")));
        canonicalGene_mRNA00002.addParent(canonicalGene_gene00001);
        canonicalGeneFeatures.add(canonicalGene_mRNA00002);

        final Gff3FeatureImpl canonicalGene_mRNA00003 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "mRNA",
                1300,
                ...
                ImmutableMap.of(
                        "ID",
                        Collections.singletonList("mRNA00003"),
                        "Name",
                        Collections.singletonList("EDEN.3"),
                        "Parent",
                        Collections.singletonList("gene00001")));
        canonicalGene_mRNA00003.addParent(canonicalGene_gene00001);
        canonicalGeneFeatures.add(canonicalGene_mRNA00003);

        final Gff3FeatureImpl canonicalGene_exon00001 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "exon",
                1300,
        ...
        final Gff3FeatureImpl canonicalGene_exon00002 = new Gff3FeatureImpl(
                ...
                ImmutableMap.of(
                        "ID",
                        Collections.singletonList("exon00002"),
                        "Parent",
                        Arrays.asList("mRNA00001", "mRNA00002")));
        ...
        final Gff3FeatureImpl canonicalGene_exon00003 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "exon",
                3000,
                ...
                ImmutableMap.of(
                        "ID",
                        Collections.singletonList("exon00003"),
                        "Parent",
        ...
        final Gff3FeatureImpl canonicalGene_exon00004 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "exon",
                5000,
                ...
                ImmutableMap.of(
                        "ID",
                        Collections.singletonList("exon00004"),
                        "Parent",
                        Arrays.asList("mRNA00001", "mRNA00002", "mRNA00003")));
        ...
        final Gff3FeatureImpl canonicalGene_exon00005 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "exon",
                7000,
                ...
                ImmutableMap.of(
                        "ID",
                        Collections.singletonList("exon00005"),
                        "Parent",
                        Arrays.asList("mRNA00001", "mRNA00002", "mRNA00003")));
        ...
        final Gff3FeatureImpl canonicalGene_cds00001_1 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "CDS",
                1201,
                ...
                ImmutableMap.of(
                        "ID",
                        Collections.singletonList("cds00001"),
                        "Parent",
                        Collections.singletonList("mRNA00001"),
                        "Name",
                        Collections.singletonList("edenprotein.1")));
        canonicalGene_cds00001_1.addParent(canonicalGene_mRNA00001);
        canonicalGeneFeatures.add(canonicalGene_cds00001_1);

        final Gff3FeatureImpl canonicalGene_cds00001_2 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "CDS",
                3000,
        ...
        final Gff3FeatureImpl canonicalGene_cds00001_3 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "CDS",
                5000,
        ...
        final Gff3FeatureImpl canonicalGene_cds00001_4 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "CDS",
                7000,
        ...
        final Gff3FeatureImpl canonicalGene_cds00002_1 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "CDS",
                1201,
                ...
                ImmutableMap.of(
                        "ID",
                        Collections.singletonList("cds00002"),
                        "Parent",
                        Collections.singletonList("mRNA00002"),
                        "Name",
                        Collections.singletonList("edenprotein.2")));
        canonicalGene_cds00002_1.addParent(canonicalGene_mRNA00002);
        canonicalGeneFeatures.add(canonicalGene_cds00002_1);

        final Gff3FeatureImpl canonicalGene_cds00002_2 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "CDS",
                5000,
        ...
        final Gff3FeatureImpl canonicalGene_cds00002_3 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "CDS",
                7000,
        ...
        final Gff3FeatureImpl canonicalGene_cds00003_1 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "CDS",
                3301,
                ...
                ImmutableMap.of(
                        "ID",
                        Collections.singletonList("cds00003"),
                        "Parent",
                        Collections.singletonList("mRNA00003"),
                        "Name",
                        Collections.singletonList("edenprotein.3")));
        canonicalGene_cds00003_1.addParent(canonicalGene_mRNA00003);
        canonicalGeneFeatures.add(canonicalGene_cds00003_1);

        final Gff3FeatureImpl canonicalGene_cds00003_2 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "CDS",
                5000,
        ...
        final Gff3FeatureImpl canonicalGene_cds00003_3 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "CDS",
                7000,
        ...
        final Gff3FeatureImpl canonicalGene_cds00004_1 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "CDS",
                3391,
                ...
                ImmutableMap.of(
                        "ID",
                        Collections.singletonList("cds00004"),
                        "Parent",
                        Collections.singletonList("mRNA00003"),
                        "Name",
                        Collections.singletonList("edenprotein.4")));
        canonicalGene_cds00004_1.addParent(canonicalGene_mRNA00003);
        canonicalGeneFeatures.add(canonicalGene_cds00004_1);

        final Gff3FeatureImpl canonicalGene_cds00004_2 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "CDS",
                5000,
        ...
        final Gff3FeatureImpl canonicalGene_cds00004_3 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "CDS",
                7000,
        ...
        final ArrayList<Object> polycistronicTranscriptExample =
                new ArrayList<>(Collections.singletonList(DATA_DIR + "polycistronic_transcript.gff3"));

        final Set<Gff3Feature> polycisctronicTranscriptFeatures = new HashSet<>();

        final Gff3FeatureImpl polycistronicTranscript_gene01 = new Gff3FeatureImpl(
                "chrX",
                ".",
                "gene",
                100,
                ...
                Strand.POSITIVE,
                -1,
                ImmutableMap.of("ID", Collections.singletonList("gene01"), "name", Collections.singletonList("resA")));
        final Gff3FeatureImpl polycistronicTranscript_gene02 = new Gff3FeatureImpl(
                "chrX",
                ".",
                "gene",
                250,
                ...
                Strand.POSITIVE,
                -1,
                ImmutableMap.of("ID", Collections.singletonList("gene02"), "name", Collections.singletonList("resB")));
        final Gff3FeatureImpl polycistronicTranscript_gene03 = new Gff3FeatureImpl(
                "chrX",
                ".",
                "gene",
                400,
                ...
                Strand.POSITIVE,
                -1,
                ImmutableMap.of("ID", Collections.singletonList("gene03"), "name", Collections.singletonList("resX")));
        final Gff3FeatureImpl polycistronicTranscript_gene04 = new Gff3FeatureImpl(
                "chrX",
                ".",
                "gene",
                550,
                ...
                Strand.POSITIVE,
                -1,
                ImmutableMap.of("ID", Collections.singletonList("gene04"), "name", Collections.singletonList("resZ")));
        ...
        final Gff3FeatureImpl polycistronicTranscript_mRNA = new Gff3FeatureImpl(
                "chrX",
                ".",
                "mRNA",
                100,
                ...
                ImmutableMap.of(
                        "ID",
                        Collections.singletonList("tran01"),
                        "Parent",
                        Arrays.asList("gene01", "gene02", "gene03", "gene04")));
        ...
        final Gff3FeatureImpl polycistronicTranscript_exon = new Gff3FeatureImpl(
                "chrX",
                ".",
                "exon",
                100,
                ...
                Strand.POSITIVE,
                -1,
                ImmutableMap.of("Parent", Collections.singletonList("tran01")));
        ...
        final Gff3FeatureImpl polycistronicTranscript_CDS1 = new Gff3FeatureImpl(
                "chrX",
                ".",
                "CDS",
                100,
                ...
                ImmutableMap.of(
                        ...
                        Collections.singletonList("tran01"),
                        "Derives_from",
                        Collections.singletonList("gene01")));
        ...
        final Gff3FeatureImpl polycistronicTranscript_CDS2 = new Gff3FeatureImpl(
                "chrX",
                ".",
                "CDS",
                250,
                ...
                ImmutableMap.of(
                        ...
                        Collections.singletonList("tran01"),
                        "Derives_from",
                        Collections.singletonList("gene02")));
        ...
        final Gff3FeatureImpl polycistronicTranscript_CDS3 = new Gff3FeatureImpl(
                "chrX",
                ".",
                "CDS",
                400,
                ...
                ImmutableMap.of(
                        ...
                        Collections.singletonList("tran01"),
                        "Derives_from",
                        Collections.singletonList("gene03")));
        ...
        final Gff3FeatureImpl polycistronicTranscript_CDS4 = new Gff3FeatureImpl(
                "chrX",
                ".",
                "CDS",
                550,
                ...
                ImmutableMap.of(
                        ...
                        Collections.singletonList("tran01"),
                        "Derives_from",
                        Collections.singletonList("gene04")));
        ...
        final ArrayList<Object> programmedFrameshiftExample =
                new ArrayList<>(Collections.singletonList(DATA_DIR + "programmed_frameshift.gff3"));

        final Set<Gff3Feature> programmedFrameshiftFeatures = new HashSet<>();

        final Gff3FeatureImpl programmedFrameshift_gene = new Gff3FeatureImpl(
                "chrX",
                ".",
                "gene",
                100,
                ...
                -1,
                ImmutableMap.of(
                        "ID", Collections.singletonList("gene01"), "name", Collections.singletonList("my_gene")));
        programmedFrameshiftFeatures.add(programmedFrameshift_gene);

        final Gff3FeatureImpl programmedFrameshift_mRNA = new Gff3FeatureImpl(
                "chrX",
                ".",
                "mRNA",
                100,
        ...
        final Gff3FeatureImpl programmedFrameshift_exon = new Gff3FeatureImpl(
                ...
                -1,
                ImmutableMap.of(
                        "ID", Collections.singletonList("exon01"), "Parent", Collections.singletonList("tran01")));
        programmedFrameshift_exon.addParent(programmedFrameshift_mRNA);
        programmedFrameshiftFeatures.add(programmedFrameshift_exon);

        final Gff3FeatureImpl programmedFrameshift_CDS1_1 = new Gff3FeatureImpl(
                "chrX",
                ".",
                "CDS",
                100,
                ...
                0,
                ImmutableMap.of(
                        "ID", Collections.singletonList("cds01"), "Parent", Collections.singletonList("tran01")));
        ...
        final Gff3FeatureImpl programmedFrameshift_CDS1_2 = new Gff3FeatureImpl(
                "chrX",
                ".",
                "CDS",
                149,
        ...
        // multiple genes
        final ArrayList<Object> multipleGenesExample =
                new ArrayList<>(Collections.singletonList(DATA_DIR + "multiple_genes.gff3"));

        final Set<Gff3Feature> multipleGenesFeatures = new HashSet<>();

        final Gff3FeatureImpl multipleGenes_gene1 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "gene",
                1000,
                ...
                Strand.POSITIVE,
                -1,
                ImmutableMap.of("ID", Collections.singletonList("gene00001")));
        multipleGenesFeatures.add(multipleGenes_gene1);

        final Gff3FeatureImpl multipleGenes_mRNA1 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "mRNA",
                1050,
                ...
                Strand.POSITIVE,
                -1,
                ImmutableMap.of("Parent", Collections.singletonList("gene00001")));
        multipleGenes_mRNA1.addParent(multipleGenes_gene1);
        multipleGenesFeatures.add(multipleGenes_mRNA1);

        final Gff3FeatureImpl multipleGenes_gene2 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "gene",
                2000,
                ...
                Strand.POSITIVE,
                -1,
                ImmutableMap.of("ID", Collections.singletonList("gene00002")));
        multipleGenesFeatures.add(multipleGenes_gene2);

        final Gff3FeatureImpl multipleGenes_mRNA2 = new Gff3FeatureImpl(
                "ctg123",
                ".",
                "mRNA",
                2050,
                ...
                Strand.POSITIVE,
                -1,
                ImmutableMap.of("Parent", Collections.singletonList("gene00002")));
    ...
    public void examplesTest(final String inputGff, final Set<Gff3Feature> expectedFeatures) throws IOException {
        final AbstractFeatureReader<Gff3Feature, LineIterator> reader =
                AbstractFeatureReader.getFeatureReader(inputGff, null, new Gff3Codec(), false);
    ...
    public Object[][] directiveDataProvider() {
        return new Object[][] {
            ...
            {
                "##sequence-region chr10 250 277",
                Gff3Codec.Gff3Directive.SEQUENCE_REGION_DIRECTIVE,
                new SequenceRegion("chr10", 250, 277)
            },
    ...
    public void directiveTest(
            final String line,
            final Gff3Codec.Gff3Directive expectedDirectiveType,
            final Object expectedDecodedDirective)
            throws IOException {
    ...
    public Object[][] directiveEncodingDataProvider() {
        return new Object[][] {
            ...
            {
                Gff3Codec.Gff3Directive.SEQUENCE_REGION_DIRECTIVE,
                new SequenceRegion("theContig", 101, 170),
                "##sequence-region theContig 101 170"
            },
            {Gff3Codec.Gff3Directive.FLUSH_DIRECTIVE, null, "###"},
    ...
    public void directiveEncodingTest(
            final Gff3Codec.Gff3Directive directive, final Object object, final String expectedEncoding) {
    ...
    public Object[][] version3InvalidDirectivesDataProvider() {
        return new Object[][] {{"3.1.a"}, {"2"}, {"2.1"}, {".3.1"}};
    }
    ...
    public Object[][] decodeAttributeValueDataProvider() {
        return new Object[][] {
            ...
            {
                "value1, value %3B with %3D special %26 encoded %2C characters, value3",
    ...
    public void decodeAttributeValueTest(
            final String attributeValueString, final List<String> expectedAttributeValues) {
    ...
    public void extractSingleAttributeTest(
            final List<String> attributes, final String expectedSingleAttribute, final boolean expectException) {
        if (expectException) {
