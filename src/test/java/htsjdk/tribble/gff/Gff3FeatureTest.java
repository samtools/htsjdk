...
public class Gff3FeatureTest extends HtsjdkTest {
    ...
    public Object[][] equalityTestDatProvider() {
        ...
        examples.add(new Object[] {
            new Gff3FeatureImpl(
                    ...
                    Strand.NEGATIVE,
                    -1,
                    ImmutableMap.of("ID", Collections.singletonList("gene01"))),
            new Gff3FeatureImpl(
                    "chr1",
                    ".",
                    "gene",
        ...
        examples.add(new Object[] {
            new Gff3FeatureImpl(
                    ...
                    0,
                    ImmutableMap.of(
                            "ID", Collections.singletonList("cds01"), "Parent", Collections.singletonList("gene01"))),
            new Gff3FeatureImpl(
                    "chr1",
                    ".",
                    "CDS",
        ...
        final Gff3FeatureImpl feature1_1 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "gene",
                1000,
                ...
                -1,
                ImmutableMap.of("ID", Collections.singletonList("gene01")));
        final Gff3FeatureImpl feature2_1 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "gene",
                1000,
                ...
                -1,
                ImmutableMap.of("ID", Collections.singletonList("gene01")));
        final Gff3FeatureImpl feature3_1 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "CDS",
                1010,
        ...
        final Gff3FeatureImpl feature4_1 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "CDS",
                1010,
        ...
        final Gff3FeatureImpl feature1_2 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "gene",
                1000,
                ...
                -1,
                ImmutableMap.of("ID", Collections.singletonList("gene01")));
        final Gff3FeatureImpl feature2_2 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "gene",
                1000,
                ...
                -1,
                ImmutableMap.of("ID", Collections.singletonList("gene01")));
        final Gff3FeatureImpl feature3_2 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "CDS",
                1010,
        ...
        final Gff3FeatureImpl feature4_2 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "CDS",
                1010,
        ...
        final Gff3FeatureImpl feature1_3 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "gene",
                1000,
                ...
                -1,
                ImmutableMap.of("ID", Collections.singletonList("gene01")));
        final Gff3FeatureImpl feature2_3 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "gene",
                1000,
                ...
                -1,
                ImmutableMap.of("ID", Collections.singletonList("gene01")));
        final Gff3FeatureImpl feature3_3 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "CDS",
                1010,
        ...
        final Gff3FeatureImpl feature4_3 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "CDS",
                1010,
        ...
        final Gff3FeatureImpl feature5_3 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "CDS",
                1080,
        ...
        final Gff3FeatureImpl feature6_3 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "CDS",
                1080,
        ...
        final Gff3FeatureImpl feature1_4 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "gene",
                1000,
                ...
                -1,
                ImmutableMap.of("ID", Collections.singletonList("gene01")));
        final Gff3FeatureImpl feature2_4 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "gene",
                1000,
                ...
                -1,
                ImmutableMap.of("ID", Collections.singletonList("gene01")));
        final Gff3FeatureImpl feature3_4 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "CDS",
                1010,
        ...
        final Gff3FeatureImpl feature4_4 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "CDS",
                1010,
        ...
        final Gff3FeatureImpl feature5_4 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "CDS",
                1080,
        ...
        final Gff3FeatureImpl feature6_4 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "CDS",
                1080,
    ...
    public void testChildren() {
        ...
        final Gff3FeatureImpl feature1 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "gene",
                1000,
                ...
                -1,
                ImmutableMap.of("ID", Collections.singletonList("gene01")));
        final Gff3FeatureImpl feature2 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "CDS",
                1010,
    ...
    public void testCofeatures() {
        ...
        final Gff3FeatureImpl region = new Gff3FeatureImpl(
                "chr1",
                ".",
                "region",
                1,
                ...
                Strand.NONE,
                -1,
                ImmutableMap.of("ID", Collections.singletonList("region01")));
        final Gff3FeatureImpl feature1 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "gene",
                ...
                -1,
                ImmutableMap.of(
                        "ID", Collections.singletonList("gene01"), "Parent", Collections.singletonList("region01")));
        ...
        final Gff3FeatureImpl feature3 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "gene",
                1700,
    ...
    public void testCofeautresDifferentParents() {
        ...
        final Gff3FeatureImpl feature2 = new Gff3FeatureImpl(
                ...
                Strand.NEGATIVE,
                -1,
                ImmutableMap.of("ID", Collections.singletonList("gene02")));
        final Gff3FeatureImpl feature3 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "CDS",
        ...
        final Gff3FeatureImpl feature4 = new Gff3FeatureImpl(
                "chr1",
                ".",
                "CDS",
                1310,
                ...
                0,
                ImmutableMap.of(
                        "ID", Collections.singletonList("cds01"), "Parent", Collections.singletonList("gene02")));
    ...
    public void testAncestorsAndDescendents() {
        ...
        final Gff3FeatureImpl topLevelFeature = new Gff3FeatureImpl(
                "chrX",
                ".",
                "type0",
                1,
                ...
                Strand.NEGATIVE,
                0,
                ImmutableMap.of("ID", Collections.singletonList("feature0")));
        ...
        for (int i = 1; i < nGenerations; i++) {
            final Gff3FeatureImpl newFeature = new Gff3FeatureImpl(
                    "chrX",
                    ".",
                    "type" + i,
                    1,
                    ...
                    ImmutableMap.of(
                            "ID",
                            Collections.singletonList("feature" + i),
                            "Parent",
                            Collections.singletonList(prevFeature.getID())));
    ...
    public void testFlatten() {
        ...
        final Map<Gff3FeatureImpl, Set<Gff3FeatureImpl>> flattenMap = new HashMap<>(
                Collections.singletonMap(topLevelFeature, new HashSet<>(Collections.singleton(topLevelFeature))));
    ...
    public void testDerivesFrom() {
        final Gff3FeatureImpl region01 = new Gff3FeatureImpl(
                "chrX",
                ".",
                "gene",
                65,
        ...
        final Gff3FeatureImpl gene01 = new Gff3FeatureImpl(
                "chrX",
                ".",
                "gene",
                1,
        ...
        final Gff3FeatureImpl gene02 = new Gff3FeatureImpl(
                "chrX",
                ".",
                "gene",
                70,
        ...
        final Gff3FeatureImpl mRNA01 = new Gff3FeatureImpl(
                "chrX",
                ".",
                "mRNA",
                1,
                ...
                -1,
                ImmutableMap.of(
                        "ID", Collections.singletonList("mRNA01"), "Parent", Arrays.asList("gene01", "gene02")));
        mRNA01.addParent(gene01);
        mRNA01.addParent(gene02);

        final Gff3FeatureImpl cds01 = new Gff3FeatureImpl(
                "chrX",
                ".",
                "CDS",
                1,
                ...
                ImmutableMap.of(
                        "ID",
                        Collections.singletonList("cds01"),
                        "Parent",
                        Collections.singletonList("mRNA01"),
                        "Derives_from",
                        Collections.singletonList("gene01")));
        cds01.addParent(mRNA01);
        final Gff3FeatureImpl cds02 = new Gff3FeatureImpl(
                "chrX",
                ".",
                "CDS",
                70,
                ...
                ImmutableMap.of(
                        "ID",
                        Collections.singletonList("cds02"),
                        "Parent",
                        Collections.singletonList("mRNA01"),
                        "Derives_from",
        ...
        final Gff3FeatureImpl codon01 = new Gff3FeatureImpl(
                "chrX",
                ".",
                "codon",
                1,
                ...
                0,
                ImmutableMap.of(
                        "ID", Collections.singletonList("codon01"), "Parent", Collections.singletonList("cds01")));
