...
public class LinearIndexTest extends HtsjdkTest {
  ...
  public void testEquals() {
    ...
    Assert.assertTrue(
        idx.equalsIgnoreProperties(idx), "Identical indices are equalIgnoreTimeStamp");
    Assert.assertTrue(
        idx.equalsIgnoreProperties(idx2), "Indices constructed the same are equalIgnoreTimeStamp");

    idx2.setTS(123456789);
    Assert.assertNotSame(idx, idx2, "Indices with different timestamps are not the same");
    Assert.assertTrue(
        idx.equalsIgnoreProperties(idx2),
        "Indices with different timestamps are equalIgnoreTimeStamp");
  }
  ...
  // chr2 (100, 200]
  // @Test()
  // TODO -- this is not a useful test as written -- the linear index always returns a single block
  // since by
  ...
  @Test
  /**
   * chr2 1 200000000 LONG_FEATURE ... chr2 179098961 179380395 Hs.134602 chr2 179209546 179287210
   * Hs.620337 chr2 179266309 179266748 Hs.609465 chr2 179296428 179300012 Hs.623987 chr2 179302952
   * 179303488 Hs.594545
   */
  public void testOverlappingFeatures() throws Exception {
    ...
    final Set<String> names =
        new HashSet<String>(
            Arrays.asList(
                "Hs.134602", "Hs.620337", "Hs.609465", "Hs.623987", "Hs.594545", "LONG_FEATURE"));
    ...
    FeatureReader<BEDFeature> bfr =
        AbstractFeatureReader.getFeatureReader(bedFile, new BEDCodec(), idx);
