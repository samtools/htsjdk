...
public class BlockCompressedAsciiLineReaderTest extends HtsjdkTest {
  ...
  public void testLineReaderPosition() throws IOException {
    ...
    try (final BlockCompressedInputStream bcis = new BlockCompressedInputStream(multiBlockFile);
        final BlockCompressedAsciiLineReader asciiLineReader =
            new BlockCompressedAsciiLineReader(bcis)) {
      String line = null;
  ...
  public void testRejectPositionalInputStream() throws IOException {
    ...
    try (final BlockCompressedInputStream bcis = new BlockCompressedInputStream(multiBlockFile);
      ...
      asciiLineReader.readLine(
          new PositionalBufferedStream(new ByteArrayInputStream(new byte[1100])));
    }
  }
  ...
  private long populateMultiBlockCompressedFile(final File tempBlockCompressedFile)
    ...
    try (BlockCompressedOutputStream bcos =
        new BlockCompressedOutputStream(tempBlockCompressedFile)) {
