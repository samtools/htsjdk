...
public class ParsingUtilsTest extends HtsjdkTest {
   ...
   *
   * <ol>
   *   <li>Ends up with the expected number of items
   *   <li>Ends up with the expected items
   *   <li>Ends up with the same items as when the split is performed using String.split
