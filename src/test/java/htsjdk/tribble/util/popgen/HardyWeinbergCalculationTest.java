...
public class HardyWeinbergCalculationTest extends HtsjdkTest {
  ...
  public void testHwCalculate(final int[] genotypeCounts, final double expectedHWS)
      throws Exception {
    Assert.assertEquals(
        HardyWeinbergCalculation.hwCalculate(
            genotypeCounts[0], genotypeCounts[1], genotypeCounts[2]),
        expectedHWS);
  }
}
