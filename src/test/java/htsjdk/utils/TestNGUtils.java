...
/**
 * Small class implementing some utility functions that are useful for test and interfacing with the
 * TestNG framework.
 */
public class TestNGUtils {

  /**
   * A Method that returns all the Methods that are annotated with @DataProvider in a given package.
   *
   * @param packageName the package under which to look for classes and methods
   * @return an iterator to collection of Object[]'s consisting of {Method method, Class clazz}
   *     pair. where method has the @DataProviderAnnotation and is a member of clazz.
   */
