  ...
  public void testAttributeResettingWorks(final boolean leaveModifyableAsIs) {
    final VariantContextBuilder root1 =
        new VariantContextBuilder(
            snpSource, snpLoc, snpLocStart, snpLocStop, Arrays.asList(Aref, C));
    ...
    // this is a red-herring and should not change anything, however, if leaveModifyableAsIs is
    // true, it does change result1.
