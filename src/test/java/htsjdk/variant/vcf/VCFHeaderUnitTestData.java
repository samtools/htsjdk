...
public class VCFHeaderUnitTestData {
    public final VCFHeaderVersion canonicalVersion = VCFHeader.DEFAULT_VCF_VERSION;
    ...
    // FILTER lines
    public final List<VCFHeaderLine> filterLines = new ArrayList<VCFHeaderLine>() {{
    ...
    // FORMAT lines
    public final List<VCFHeaderLine> formatLines = new ArrayList<VCFHeaderLine>() {{
    ...
    // INFO lines
    public final List<VCFHeaderLine> infoLines = new ArrayList<VCFHeaderLine>() {{
    ...
    // CONTIG lines
    public final List<VCFHeaderLine> contigLines = new ArrayList<VCFHeaderLine>() {{
    ...
    //misc lines
    public final List<VCFHeaderLine> miscLines = new ArrayList<VCFHeaderLine>() {{
