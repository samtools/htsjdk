...
public class VCFPedigreeHeaderLineUnitTest {
    ...
    private static String pedigreeString = "PEDIGREE=<ID=id,Description=desc>";

    @Test(dataProvider="allowedVCFVersions")
    public void testAllowedVersions(final VCFHeaderVersion vcfAllowedVersion) {
        VCFPedigreeHeaderLine vcfLine = new VCFPedigreeHeaderLine(pedigreeString, vcfAllowedVersion);
    ...
    public void testRejectedVersions(final VCFHeaderVersion vcfAllowedVersion) {
        new VCFPedigreeHeaderLine(pedigreeString, vcfAllowedVersion);
    }
